...
bool HelloWorldPublisher::init()
{
    if (eprosima::fastrtps::xmlparser::XMLP_ret::XML_OK !=
            eprosima::fastrtps::xmlparser::XMLProfileManager::loadXMLFile("../generic_subscriber/example_type.xml"))
    {
        std::cout << "Cannot open XML file \"../generic_subscriber/example_type.xml\". Please, run the publisher from the folder "
    ...
    topic_ = mp_participant->create_topic("DDSDynHelloWorldTopic", m_type.get_type_name(), TOPIC_QOS_DEFAULT);
